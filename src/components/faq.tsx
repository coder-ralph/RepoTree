...
const FAQItem = ({ question, answer }: FAQItemProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <h4 className="text-base sm:text-xl md:text-2xl font-semibold text-gray-900 dark:text-white">
          {question}
        </h4>
        {isOpen ? (
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <p className="px-6 pb-6 text-sm sm:text-base md:text-lg text-gray-600 dark:text-gray-300">
              {answer}
            </p>
          </motion.div>
        )}
