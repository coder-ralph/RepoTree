...
export default function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      />
      <Sun className="absolute left-2 h-5 w-5 text-yellow-500 dark:text-gray-400" aria-hidden="true" />
      <Moon className="absolute right-2 h-5 w-5 text-gray-400 dark:text-gray-500" aria-hidden="true" />
    </button>
  )
}
